...
public class PasswordAdapter extends BaseAdapter implements Filterable {
    ...
    public PasswordAdapter(Activity activity, ArrayList<Game> games, int layout, int isInvinsible  ) {
        ...
        Collections.sort(filteredList, new Comparator<Game>() {
            ...
            public int compare(Game game1, Game game2) {
                if (game1.getDate() != null) {
                    ...
                    try {
                        date1 = new SimpleDateFormat("MM/dd/yyyy hh:mm").parse(sDate1);
                        date2 = new SimpleDateFormat("MM/dd/yyyy hh:mm").parse(sDate2);
