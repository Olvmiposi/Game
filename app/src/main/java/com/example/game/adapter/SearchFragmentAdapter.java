...
public class SearchFragmentAdapter extends BaseAdapter {
    ...
    public SearchFragmentAdapter(Activity activity, ArrayList<Game> games, int layout, int isInvinsible, String baseUrl ) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(layout == (R.layout.schrodinger_activity_rows))
        {
            ...
            try {
                ...
                }else if (currentGame.getSchrodinger() == 1){
        ...
        else if(layout == (R.layout.schrodinger_rows))
        {
            ...
            if(Objects.equals(currentGame.checked, 1)){
            ...
            }else if(currentGame.schrodinger == 1){
                lLayout.setBackgroundColor(Color.parseColor("#F9AA33"));//yellow
            }
            else if(Objects.equals(currentGame.home, "null")){
                ...
                for (Game game : predictionsList) {
                    ...
                    else if (Objects.equals(currentGame.username, game.username)){
